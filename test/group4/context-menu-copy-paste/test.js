...
module.exports = {
  'init': function(browser) {
    browser
      ...
      .assert.cssProperty('.sketch-editor-context-menu .copy', 'display', 'none')
      ...
      .mouseButtonDown(2)
      .mouseButtonUp(2)
      .assert.cssProperty('.sketch-editor-context-menu .copy', 'display', 'flex')
      ...
      .mouseButtonDown(2)
      .mouseButtonUp(2)
      .moveToElement('.sketch-editor-context-menu .paste', 10, 10)
      .mouseButtonDown(0)
      .mouseButtonUp(0)
      .keys(browser.Keys.META)
      .keys('a')
