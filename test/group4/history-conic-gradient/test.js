...
module.exports = {
  'init': function(browser) {
    browser
      ...
      .mouseButtonDown(0)
      .mouseButtonUp(0)
      .assert.cssProperty('#main .gradient span[title="0"]', 'left', '31.9141px')
      .assert.cssProperty('#main .gradient span[title="0"]', 'top', '111.383px')
      .assert.cssProperty('#main .gradient span[title="0"]', 'backgroundColor', 'rgba(0, 0, 0, 255)')
