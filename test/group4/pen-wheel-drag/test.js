...
module.exports = {
  'init': function(browser) {
    browser
      ...
      .mouseButtonDown(0)
      .mouseButtonUp(0)
      .assert.elementPresent('#main .geometry .vt[title="0"]')
      .moveToElement('canvas', 100, 50)
      .mouseButtonDown(0)
      .mouseButtonUp(0)
      .assert.elementPresent('#main .geometry .vt[title="1"]')
      .moveToElement('canvas', 100, 100)
      .mouseButtonDown(0)
      .mouseButtonUp(0)
      .assert.elementPresent('#main .geometry .vt[title="2"]')
      .moveToElement('canvas', 200, 200)
      .mouseButtonDown(1)
      .assert.not.cssClassPresent('#main .canvas-c', 'add-pen')
      .moveToElement('canvas', 190, 190)
      .mouseButtonUp(1)
      .assert.not.elementPresent('#main .geometry .vt[title="3"]')
