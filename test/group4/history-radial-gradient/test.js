...
module.exports = {
  'init': function(browser) {
    browser
      ...
      .assert.cssProperty('#main .gradient .c', 'left', '75px')
      .assert.cssProperty('#main .gradient .c', 'top', '50px')
      .assert.cssProperty('#main .gradient .c', 'width', '180.278px')
      .assert.cssProperty('#main .gradient .c', 'height', '180.278px')
      .assert.cssProperty('#main .gradient .e', 'left', '25px')
      .assert.cssProperty('#main .gradient .e', 'top', '125px')
      .assert.cssClassPresent('#main .gradient span[title="0"]', 'cur')
      .assert.cssProperty('#main .gradient span[title="0"]', 'left', '75px')
