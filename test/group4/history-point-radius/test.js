...
module.exports = {
  'init': function(browser) {
    browser
      ...
      .assert.domPropertyEquals('#side .point-panel .num input[type="range"]', 'disabled', 'disabled')
      .assert.domPropertyEquals('#side .point-panel .num input[type="number"]', 'disabled', 'disabled')

      .click('#main .geometry .vt[title="0"]')
      .assert.domPropertyEquals('#side .point-panel .num input[type="range"]', 'disabled', '')
      .assert.domPropertyEquals('#side .point-panel .num input[type="number"]', 'disabled', '')
