...
module.exports = {
  'init': function(browser) {
    browser
      ...
      .pause(20)
      .click('#button3')
      .assert.value('#base64', '[1,[{"location":0,"length":4,"fontFamily":"Helvetica","fontSize":24,"fontWeight":400,"fontStyle":"normal","letterSpacing":0,"textAlign":0,"textDecoration":[],"lineHeight":28.59765625,"paragraphSpacing":0,"color":[78,78,78,1]},{"location":4,"length":3,"fontFamily":"Helvetica","fontSize":36,"fontWeight":400,"fontStyle":"normal","letterSpacing":0,"textAlign":0,"textDecoration":[],"lineHeight":61,"paragraphSpacing":0,"color":[78,78,78,1]}]]')
      .assert.value('#side .text-panel .lh input', '')
      .assert.attributeEquals('#side .text-panel .lh input', 'placeholder', '多个')
      ...
      .pause(20)
      .click('#button3')
      .assert.value('#base64', '[2,[{"location":0,"length":4,"fontFamily":"Helvetica","fontSize":24,"fontWeight":400,"fontStyle":"normal","letterSpacing":0,"textAlign":0,"textDecoration":[],"lineHeight":38.59765625,"paragraphSpacing":0,"color":[78,78,78,1]},{"location":4,"length":3,"fontFamily":"Helvetica","fontSize":36,"fontWeight":400,"fontStyle":"normal","letterSpacing":0,"textAlign":0,"textDecoration":[],"lineHeight":71,"paragraphSpacing":0,"color":[78,78,78,1]}]]')
      ...
      .updateValue('#side .text-panel .lh input', ['', browser.Keys.ENTER])
