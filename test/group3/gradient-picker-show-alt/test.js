...
module.exports = {
  'init': function(browser) {
    browser
      ...
      .mouseButtonDown(0)
      .mouseButtonUp(0)
      .moveToElement('#side .stroke-panel .line[title="0"] .pick', 5, 5)
      .mouseButtonDown(0)
      .mouseButtonUp(0)
      ...
      .assert.cssProperty('.sketch-editor-picker', 'display', 'block')
      .assert.cssClassPresent('.sketch-editor-picker', ['sketch-editor-picker', 'strokePanel0'])
      .moveToElement('#side .stroke-panel .line[title="1"] .pick', 5, 5)
      .mouseButtonDown(0)
      .mouseButtonUp(0)
      .assert.elementPresent('.sketch-editor-picker')
      .assert.cssProperty('.sketch-editor-picker', 'display', 'block')
      ...
      .moveToElement('#side .fill-panel .line[title="0"] .pick', 5, 5)
      .mouseButtonDown(0)
      .mouseButtonUp(0)
      .assert.elementPresent('.sketch-editor-picker')
      .assert.cssProperty('.sketch-editor-picker', 'display', 'block')
