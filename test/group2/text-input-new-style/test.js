...
module.exports = {
  'init': function(browser) {
    browser
      ...
      .mouseButtonUp(0)
      .pause(20)
      .assert.cssProperty('#side .text-panel .picker-btn b', 'backgroundColor', 'rgba(0, 0, 255, 1)')
      .keys('5')
      .keys(browser.Keys.NULL)
      .click('#button3')
