...
module.exports = {
  'init': function(browser) {
    browser
      ...
      .keys(browser.Keys.NULL)
      .click('#button3')
      .assert.value('#base64', '[14,[{"location":0,"length":3,"fontFamily":"Helvetica","fontSize":72,"fontWeight":400,"fontStyle":"normal","letterSpacing":0,"textAlign":0,"textDecoration":[],"lineHeight":0,"paragraphSpacing":0,"color":[0,0,0,1]}]]')
      .click('#button5')
      .assert.value('#base64', '[15,"134"]')
